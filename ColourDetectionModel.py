...
class ColourDetector():
    ...
    def getProcessedFrame(self, imagePath):
           
        ##Check is a still image or a video frame should be processed
        ...
        if self.trackingSetting == True:
            ...
            if largestArea > -1 and largestValues[2]>10 and largestValues[3] > 10:
